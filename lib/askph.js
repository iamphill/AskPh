  ...
  request(url, (function (error, response, body) {
    ...
    json['tracks'].forEach(function (track) {
      ...
      var data = {
        ...
        enclosure: {
          '@': {
            // url: track['stream_url'].replace("https", "http") + '?client_id=' + settings['client_id'],
            url: 'https://ec-media.soundcloud.com/YdoSiX6xss7O.128.mp3?f10880d39085a94a0418a7ef69b03d522cd6dfee9399eeb9a522039d6dfcb73db71862962f6eaaf72d916858ca5dc7023f4953800b65001dd45e66f2a35ce6461e6ebad02e&AWSAccessKeyId=AKIAJNIGGLK7XA7YZSNQ&Expires=1421249102&Signature=QkvA0ClM1ZN940%2F8WP6IKTk2IiM%3D',
